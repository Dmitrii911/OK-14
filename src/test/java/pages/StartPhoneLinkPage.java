...
public class StartPhoneLinkPage extends BasePage {
    ...
    public String selectCountryByName(String countryName){
        ...
        String countryCode = countryItem.find(".country-select_code").text(); //Прокручиваем к стране и выбираемее
        countryItem.click();
        return countryCode;
    ...
    public void recieveCode() {recieveCodeButton.shouldBe(visible).click();}
    @Step("Наличие сообщения об ошибке")
    public String recieveMessage() {return errorMessage.shouldBe(visible).getText();}
